...
const ITEMS: NavItem[] = [
  { href: "/guard",              label: "Panel",      icon: Home          },
  { href: "/guard/visitors",     label: "Visitantes", icon: Users         },
  { href: "/guard/packages",     label: "Paquetes",   icon: Package       },
  { href: "/guard/reservations", label: "Reservas",   icon: CalendarCheck },
];
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "text-[var(--brand-700)]"
                  : "text-[var(--slate-400)] hover:text-[var(--slate-600)]",
              )}
            >
