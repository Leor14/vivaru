...
export function EnvironmentBanner() {
  ...
  return (
    <div
      role="status"
      data-env-banner=""
      className="flex items-center justify-center gap-2 bg-[var(--tinte-ambar-fondo-1)] px-3 py-1 text-center text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--on-fill)]"
    >
