...
import { BarChart2, BookOpen, Building2, CalendarCheck, ChevronDown, ClipboardList, FileText, Gauge, Grid3X3, Home, Landmark, LifeBuoy, Lock, LogOut, MessageSquare, Package, PiggyBank, Receipt, Scale, ScrollText, Store, Users, Wallet } from "lucide-react";
...
export const ADMIN_SIDEBAR_GROUPS: AdminSidebarGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // `FEAT-010`. Detrás de Libro y fondos porque reparte por cuenta ese mismo saldo.
      // Se pinta siempre, como Medidores: la página dice si falta la bandera.
      { href: "/admin/finanzas/tesoreria", label: "Tesorería", icon: Landmark },
