...
> **Lo que NO hay que confundir:** infraestructura desplegada no es funcionalidad en uso. Ningún cliente real ha usado ninguna capacidad asistida — producción **no tiene ni un conjunto real**: la cifra de «dos» contaba `Bromelias` y `Queretarock`, y David confirmó el 24 de agosto de 2026 que **ninguno de los dos** es cliente. **0 tickets y 1 comunicación de marzo**. El programa está limitado por materia prima comercial, no por ingeniería.
