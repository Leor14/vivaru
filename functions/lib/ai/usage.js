...
exports.PRICE_TABLE_VERSION = exports.AI_USAGE_COLLECTION = void 0;
 ...
 */
exports.AI_USAGE_COLLECTION = "aiUsage";
/**
 ...
 */
exports.PRICE_TABLE_VERSION = "2026-08";
...
function estimateCostUsd(model, inputTokens, outputTokens) {
    ...
    if (!precio) {
        logger.warn("aiUsage: modelo sin precio en la tabla", { model, version: exports.PRICE_TABLE_VERSION });
        return 0;
    }
...
async function recordAiUsage(entry) {
    try {
        ...
        await (0, firestore_1.getFirestore)()
            .collection(exports.AI_USAGE_COLLECTION)
            .add({
            ...entry,
            estimatedCostUsd,
            priceTableVersion: exports.PRICE_TABLE_VERSION,
