...
exports.DIA_MAX = exports.MIN_CICLO_DIAS = void 0;
exports.diaDeAvisoValido = diaDeAvisoValido;
exports.cicloDeVencidasValido = cicloDeVencidasValido;
exports.fechaUTC = fechaUTC;
exports.tocaAvisoHoy = tocaAvisoHoy;
exports.tocaVencidasHoy = tocaVencidasHoy;
/**
...
function diaDeAvisoValido(valor) {
    if (valor === null || valor === undefined)
        return true; // desactivado
    return typeof valor === "number" && Number.isInteger(valor) && valor >= 1 && valor <= exports.DIA_MAX;
}
/** R6 · el ciclo de vencidas: mínimo `MIN_CICLO_DIAS`, o desactivado. */
function cicloDeVencidasValido(valor) {
    if (valor === null || valor === undefined)
        return true; // desactivado
    return typeof valor === "number" && Number.isInteger(valor) && valor >= exports.MIN_CICLO_DIAS;
}
 ...
 */
function tocaAvisoHoy(cal, hoy) {
    const dia = cal.noticeDayOfMonth;
    if (!diaDeAvisoValido(dia) || dia === null || dia === undefined)
        return false;
 ...
 */
function tocaVencidasHoy(cal, hoy) {
    const ciclo = cal.overdueCycleDays;
    if (!cicloDeVencidasValido(ciclo) || ciclo === null || ciclo === undefined)
        return false;
