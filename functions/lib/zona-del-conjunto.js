...
exports.zonaDelConjunto = zonaDelConjunto;
exports.instanteEnZona = instanteEnZona;
exports.diaDeLaSemana = diaDeLaSemana;
/**
 ...
 */
function zonaDelConjunto(country) {
    if (country === "CO")
...
function desfaseEnMinutos(instante, zona) {
 ...
 */
function instanteEnZona(fecha, hora, zona) {
    ...
    if (mes < 1 || mes > 12 || horas > 23 || minutos > 59)
        return null;
    ...
    if (comprobacion.getUTCDate() !== dia || comprobacion.getUTCMonth() !== mes - 1)
        return null;
