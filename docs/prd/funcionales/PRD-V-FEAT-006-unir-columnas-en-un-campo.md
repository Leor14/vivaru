...
| **Estado** | **EN PRODUCCIÓN** (1 sep 2026, 22:17 UTC: `build-2026-09-01-019` ← `6548e51`, medido por `traffic.current`). Antes, **construida y validada en staging con ojos** (`24b9741`, `build-2026-09-01-024`): los diecisiete criterios, quince por prueba automática falsada y `CA7`, `CA8`, `CA13`, `CA15`, `CA16`, `CA17` vistos en pantalla con las fixtures `53`, `56`, `50` y `60`. **`registrarImportacion` en producción** (`00015-jeh`, verificada por identidad del fuente) y en staging (`00018-dis`). **`G1` sigue abierta**: la cierra un cliente que importe, no este despliegue · **v1.2**: construirla corrigió `CA9` y la métrica de §2 — ver §0 |
