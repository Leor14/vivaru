...
| **Responsable** | David |
| **Estado** | 🟡 **EN DESARROLLO** (11 sep 2026 por la noche, rama `trabajo/fix-005-puertas-publicas`). **Arrancó sola** tras las ventanas de producción de ese día, por decisión de David. **Hecho: H2** —`tenantMember` exige la membresía activa, con el mismo criterio que las functions—: los tres `CF5` en rojo contra la regla de antes, **482** pruebas de reglas en verde (475 + 7) y dos falsaciones que enrojecen exactamente la suya. **Antes: Lista para desarrollo** (11 sep 2026). Sale de repasar un video sobre cinco errores de las apps hechas con IA y de la auditoría que lo contrastó con el código el mismo día |
