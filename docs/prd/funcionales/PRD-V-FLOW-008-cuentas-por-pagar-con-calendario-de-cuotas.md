...
| **Responsable** | David |
| **Estado** | 🟢 **LAS TRES ENTREGAS EN PRODUCCIÓN** (4 sep 2026, `3f0de0a`), con la bandera **ENCENDIDA en los nueve** por el valor global desde el 4 sep (esta celda decía «apagada» y se quedó atrás; en staging, Las Playas la tiene apagada). `R8` cerrado. Escrita tras medir el código y los datos de producción; **David cerró las dos preguntas abiertas y aceptó `G1` vacía el mismo día**. Ver §14 |
