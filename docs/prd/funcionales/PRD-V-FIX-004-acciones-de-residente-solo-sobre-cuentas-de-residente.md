...
| **Responsable** | David |
| **Estado** | **Lista para desarrollo** (11 sep 2026). Encontrado **de paso**, midiendo para `PLAT-002` entrega 2. Decisión de David del mismo día: **va primero y aparte**, antes que lo de administradores, y **después** de la ventana de producción de las 18:00 |
