...
**Las once funcionales, por estado:** 2 productivas · **6 en producción** (`PLAT-001`,
`PLAT-003`, `FEAT-003`, `FIX-001`, `FLOW-002` y la entrega 1 de `PLAT-002`) · **1 con su MVP
completo EN STAGING** (`PLAT-002`, esperando decisión de producción) · 3 listas para desarrollo
...
| # | PRD | Por qué aquí |
|---|---|---|
| 1 | **`PLAT-002` · auditoría de las callables** ✅ **en producción** (23 ago) — **pero eran DIECIOCHO, no once**: quedaron vivas las seis del dinero hasta el 25 ago (`dbb3f29`, en staging) | Va **sola y primero**. Es el único cambio del lote que **no se revierte con una bandera** |
...
| ~~10~~ | ~~**`PLAT-002` · entrega 2**~~ ✅ **HECHA y en staging** (25 ago). La **vista** de cartera no entraba: el Story Map la sitúa en Fase 2 |
