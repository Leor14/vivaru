...
| 6 | **`FLOW-002` · anticipos** | Desbloqueada: `PLAT-003` aterrizó el 23 ago. **PRD en v1.2, lista para desarrollo** |
...
>
> **Estado al 23 de agosto de 2026 (noche): `PLAT-003` ATERRIZÓ.** Está en producción con sus
> banderas apagadas, así que ya no hay nada en vuelo sobre `aplicarPago` y **`FLOW-002` puede
> arrancar**. Esta nota decía lo contrario hasta hoy; se conserva la regla —no pueden estar en
> vuelo a la vez— porque vuelve a aplicar en cuanto haya una tercera PRD sobre la misma función.
